...
class VISFocalPlane(object):
    """Class for storing and manipulating the corners of the VIS CCDs.
    """
    ...
    def __init__(self):
        ...
        # Since we don't know the original projection of the VIS
    ...
    def rotate(self, ra, dec):
        """Rotate the corners of the VIS CCDs to a given sky location.
    ...
    def project(self, basemap, ra, dec):
        """Apply the given basemap projection to the VIS focal plane at a
        ...
        """
        raise DeprecationWarning("VISFocalPlane.project is deprecated.")
